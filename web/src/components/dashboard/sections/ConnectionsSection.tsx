...
const setupSteps = [
  { n: "01", title: "Gradient AI pre-flight", body: "We prepare the provider application, redirect URI or portal-invite identity, and encrypted server-side secret storage." },
  { n: "02", title: "Customer authorization", body: "An authorized owner completes OAuth or sends the requested portal invite. Gradient AI never asks for a password." },
      ...
      <Dialog open={!!dialog} onOpenChange={(o) => !o && setDialog(null)}>
        <DialogContent className="max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>A repeatable, customer-safe connection process. Gradient AI requests read-only access.</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 rounded-lg border border-[hsl(var(--brand))]/25 bg-[hsl(var(--brand))]/5 p-3 text-sm text-muted-foreground">
              ...
              Read-only access · Gradient AI never asks for a password.
            </div>
