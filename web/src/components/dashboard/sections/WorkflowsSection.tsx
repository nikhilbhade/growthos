  ...
  return (
    <div className="space-y-6">
      <SectionHeading
        ...
        description="Gradient AI watches the chosen trailing windows, drafts a budget reallocation when a trigger is met, and always keeps a person in control before anything changes."
        right={
          <Button size="sm">
      ...
      <Tabs defaultValue="build">
        ...
        <TabsContent value="review">
          <EmptyStage
            ...
            body="When a trigger fires, Gradient AI drafts a budget reallocation and routes it here. Approve to advance a move to Deploy, or request changes to send it back."
          />
        </TabsContent>
