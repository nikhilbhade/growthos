...
// Knowledge-grounding expectations (M3): query -> a doc id that must appear in
// the top results. Run against the Node fallback so they hold in CI too.
const knowledge = [
  { id: 'kb-roas', category: 'knowledge', query: 'can you tell me my ROAS and revenue', provider: 'meta', expectTopIds: ['metric-roas-unavailable'] },
  { id: 'kb-attribution', category: 'knowledge', query: 'how is a conversion attributed and what lookback window is used', provider: 'all', expectTopIds: ['attribution-window'] },
  { id: 'kb-tiktok-structure', category: 'knowledge', query: 'what is the ad group and advertiser structure', provider: 'tiktok', expectTopIds: ['structure-tiktok'] },
  { id: 'kb-provider-filter', category: 'knowledge', query: 'account structure and access scope', provider: 'tiktok', mustNotIds: ['structure-meta', 'sop-meta'] }
];

module.exports = { chat, unit, knowledge };
