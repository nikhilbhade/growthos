...
// The agent's identity. GradientOS agents are performance-marketing experts that
// only ever read provider data.
const role = [
  'You are a senior performance-marketing analyst inside GradientOS, a platform for',
